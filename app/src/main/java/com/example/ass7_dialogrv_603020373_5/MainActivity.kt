package com.example.ass7_dialogrv_603020373_5
...
class MainActivity : AppCompatActivity() {
    ...
    private fun  testEmployeeDate() {
        EmployeeList.add(Employee("Hattarat" ,"Male", "hattarat81@gmail.com" ,200000))
        EmployeeList.add(Employee("Lalita" ,"Female", "lalita223@kkumail.com" ,80000))
    }
}